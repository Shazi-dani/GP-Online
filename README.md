...
Java Script is used via script at the bottom of the page for animating the pop up window when submitting a registration form
...
Social Media links	To go to External Link	Click On	Taken to External Link
responsive header Image dropdown	To go to Named page	Click On	Taken to Named Page
...
Be able to navigate easily through the site,
Be informed and drawn into the site,
Be able to seek more information.
Result As a user I was able to undersatnd how to use the site and what is the purpose of the site.

That the site was about Gp Online Consultation,
The navigation was clear and I could easily go to the information I was seeking,
I was informed and drawn into the site,
I was able to seek for more information via links and via a customer service contact information.
...
Once this is done the page will automatically creat the ribbon with the http host page name that is been hosted by GitHub. The live link can be found here : https://luizsmania.github.io/TheGoodTraveller/
Clone Project
